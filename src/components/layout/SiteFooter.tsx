...
export function SiteFooter() {
  return (
    <footer className="mt-12 bg-white/[0.04] px-8 py-6 backdrop-blur-2xl">
        ...
        <div className="flex items-center gap-2">
          {[["twitter", "https://twitter.com/tirbeo"], ["github", "https://github.com/TIRBEO"], ["discord", "https://discord.gg/tirbeo"], ["linkedin", "https://linkedin.com/company/tirbeo"]].map(([icon, url]) => (
            <a key={icon} href={url} target="_blank" rel="noopener noreferrer"
              className="flex h-8 w-8 items-center justify-center bg-white/[0.04] text-white/40 backdrop-blur-2xl transition-all hover:bg-white/[0.08] hover:text-white"
